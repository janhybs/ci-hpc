...
from cihpc.visualisation.www.rest import ConfigurableView
from cihpc.utils.caching import cached
from cihpc.artifacts.db.mongo import CIHPCMongo

from cihpc.utils import strings, dateutils
from cihpc.utils import datautils as du
from cihpc.utils.logging import logger
from cihpc.utils.strings import str2bool
from cihpc.utils.timer import Timer
from cihpc.visualisation.cfg.project_config import ProjectConfig, ViewMode
from cihpc.visualisation.www.engines.highcharts import ChartGroup
...
class SparklineView(ConfigurableView):
    ...
    def prepare(project, base64data=None):
        ...
        logger.info(strings.to_json(options), skip_format=True)
