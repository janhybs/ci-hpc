...
from cihpc.structures.project_step import ProjectStep
from cihpc.structures.project_section import ProjectSection
from cihpc.structures.project import Project

from cihpc.utils.datautils import merge_dict, iter_over
from cihpc.processing.step.step_git import process_step_git
from cihpc.processing.step.step_shell import process_step_shell, ShellProcessing, ProcessConfigCrate, process_popen
from cihpc.processing.step.step_collect import process_step_collect
from cihpc.utils.parallels import extract_cpus_from_worker
from cihpc.utils.timer import Timer

# from multi_processing.pool import WorkerPool, Worker, PoolInt
from cihpc.processing.multi_processing.thread_pool import WorkerPool, Worker, PoolInt
    ...
    def process_section(self, section):
        ...
        for step in section.steps:
            ...
            if step.smart_repeat.is_complex() and global_configuration.project_git:
                from cihpc.artifacts.collect.modules import CIHPCReportGit
            ...
            try:
                ...
                if section.name == 'test' and processes and len(processes) > 0:
                    from cihpc.artifacts.collect.modules import CIHPCReport, CIHPCMongo
