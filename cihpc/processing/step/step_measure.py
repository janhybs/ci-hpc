...
def process_step_measure(step, measure, shell_processing):
    ...
    :type measure:         structures.project_step.ProjectStepMeasure
    :type shell_processing: proc.step.step_shell.ShellProcessing
    """
    if not measure:
        return
    ...
    kwargs = dict(
        ...
        random4=cihpc.utils.strings.generate_random_key(4),
    )
